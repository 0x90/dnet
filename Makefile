...
ACLOCAL = ${SHELL} /Users/090h/Downloads/libdnet-1.12/config/missing --run aclocal-1.6
AUTOCONF = ${SHELL} /Users/090h/Downloads/libdnet-1.12/config/missing --run autoconf
AUTOMAKE = ${SHELL} /Users/090h/Downloads/libdnet-1.12/config/missing --run automake-1.6
AUTOHEADER = ${SHELL} /Users/090h/Downloads/libdnet-1.12/config/missing --run autoheader
...
OBJEXT = o
PATH_SEPARATOR = :
AMTAR = ${SHELL} /Users/090h/Downloads/libdnet-1.12/config/missing --run tar
AR = ar
AS = @AS@
AWK = gawk
CC = gcc
...
am__include = include
am__quote = 
install_sh = /Users/090h/Downloads/libdnet-1.12/config/install-sh
...
am__depfiles_maybe =
DIST_SOURCES =
DIST_COMMON = Makefile.am Makefile.in setup.py.in
all: all-am
